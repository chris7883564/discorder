...
devDependencies:
    ...
    vitest:
        specifier: ^1.1.0
        version: 1.1.0(@types/node@20.10.6)
...
packages:
    ...
    /@thi.ng/bitstream@2.2.39:
        resolution:
            {
                integrity: sha512-GjD5mpvu8LHmuGa3LMar5oCF0pxdzBP+ZJCtALRvJqvAuBDfXD1cuVbnivPgQjEThIPKX5oht91Q0EKubtbEJQ==,
            }
        engines: { node: ">=18" }
        dependencies:
            "@thi.ng/errors": 2.4.9
    ...
    /@thi.ng/errors@2.4.9:
        resolution:
            {
                integrity: sha512-+h9yeU0Gi/gNihsof71kCHJy+1AzNLK+39gT478lYCLilVN8hXYfwSF9XksCPt22mwlSDI3azW4SX9TJcOZ8qg==,
            }
        engines: { node: ">=18" }
        dev: false
    ...
    /@types/node-wav@0.0.3:
        resolution:
            {
                integrity: sha512-U53HwwM1qt/WAl+rZkxpM0nkOo7JdabgKs8HHt0h+wL/SkIw42pY38JRGd6x2tSE8XJyxk8Z71xYCfjjxfmE8A==,
            }
        dependencies:
            "@types/node": 20.10.6
        dev: true
    ...
    /@types/wav@1.0.4:
        resolution:
            {
                integrity: sha512-s8C6tD2lPnkNkX2rWl0FMSpOXrKb3zB9eRO36p2bViSVw9lVJLSJRK7sOe7lOQ13YpM22/K91o/stMempoWPFw==,
            }
        dependencies:
            "@types/node": 20.10.6
        dev: true
    ...
    /@wasm-audio-decoders/flac@0.2.3:
        resolution:
            {
                integrity: sha512-hCnex6u10XWUEffOCzs1jqTePdLmTKam/p7m/R0Fp4kcwfNgEN3FVmPNeLyvSuGBL2iftBfy+XdI69Ho724Gqw==,
            }
        dependencies:
            "@wasm-audio-decoders/common": 9.0.4
            codec-parser: 2.4.3
    ...
    /@wasm-audio-decoders/ogg-vorbis@0.1.14:
        resolution:
            {
                integrity: sha512-BNxqhLFx8usdT6axGEqZ0VRM7pDob3NjJNwl+XfxsUqfsmQJ5cruwiiAMDLoFMZc+j1JGMsoTZQoyxHNQl3aCA==,
            }
        dependencies:
            "@wasm-audio-decoders/common": 9.0.4
            codec-parser: 2.4.3
    ...
    /ogg-opus-decoder@1.6.10:
        resolution:
            {
                integrity: sha512-aTSKiAUxj1kNBkErCsJJv/AvpTNCRUuYdOz+4vU82DJlx2WGI1ssS0oKe6CS62GAO/IE++qt6MimXl0lpNeIxQ==,
            }
        dependencies:
            "@wasm-audio-decoders/common": 9.0.4
            codec-parser: 2.4.3
    ...
    /opus-decoder@0.7.5:
        resolution:
            {
                integrity: sha512-c4Q8DfKg0bZFJnfGADWAKYMQbEiMlWypzeQ5p7cxXy3n/ZYVJTGzXtw+z5hbaLtj97MAmqKm5XOJrlmthmDnZA==,
            }
        dependencies:
            "@wasm-audio-decoders/common": 9.0.4
        dev: false
    ...
    /smart-whisper@0.7.0:
        resolution:
            {
                integrity: sha512-neHJe/y3J7HJUF2B/B0Ya4vmN/71K6GIUrLbQ+B2SnHCmdCX+1p+ZwvBeBSj4+wlDtwPZBA/r5Bq79eLB9WgGQ==,
            }
        requiresBuild: true
        dependencies:
            node-addon-api: 7.1.0
    ...
    /vitest@1.1.0(@types/node@20.10.6):
        resolution:
            {
